...
const subcategories = {
  referral: ['推荐1人', '推荐2人', '推荐3人', '推荐5人', '推荐7人', '推荐10人'],
...
module.exports = {
  ...
  // 「下单成功通知」订阅消息模板 ID（信息查询类，编号 7368）
  // 用于：用户提交订单后立刻推一条"已收到申请"。云端推送在 submit-order 里用同一个值。
  orderPlacedTmplId: '4zU26DwALOyDtm8yRSNmO0vnriyKWW-usUtk2MjGjkg'
};
